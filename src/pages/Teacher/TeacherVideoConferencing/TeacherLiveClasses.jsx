...
const TeacherLiveClasses = () => {
    ...
    const fetchLiveClasses = async () => {
        try {
            const response = await LiveClassesService.getByModerator(authenticationService.getUserId());
    ...
    const fetchTeacher = async () => {
        try {
            const response = await teacherService.getTeacherByUserId(authenticationService.getUserId())
