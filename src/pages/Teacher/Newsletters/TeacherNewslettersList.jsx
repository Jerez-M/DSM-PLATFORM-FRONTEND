...
export async function teacherNewslettersLoader() {
    try {
        const newslettersResponse = await NewsletterService.getAllByAudience(AuthenticationService.getUserTenantId(), "teachers");
...
export default TeacherNewsletterList;