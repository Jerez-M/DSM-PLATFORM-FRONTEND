...
export async function StudentsWithoutclassesLoader() {
    try {
        const response =
            await StudentClassService.getStudentsWithoutClassesByTenantId(
...
const StudentsWithoutClasses = () => {
    ...
    return (
        <>
            ...
            <div className="d-flex justify-content-between align-items-center">
                <h3>Students Without Classes</h3>
            </div>
    ...
    export default StudentsWithoutClasses;
