...
export async function allAdminClassroomCourseworkLoader() {
...
const AllAdminCourseworkPage = ({}) => {
                ...
                <Space size="small">
                    <Tooltip title="More details">
                        <Button
                            ...
                            icon={<EyeOutlined />}
                            onClick={() => {
                                navigate(`/admin/classroom/coursework/view/${record.id}`);
                            }}
                        />
                    </Tooltip>
                </Space>
    ...
    const fetchCourseworkByTermId = async(term_id) => {
        try {
            const currentCoursework = await courseworkService.getAllByClassroomIdAndTermId(classroom_id, term_id)
