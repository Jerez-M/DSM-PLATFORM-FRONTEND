...
export const allElectronicsBySupplierLoader = async ({params}) => {
    try {
        const categoryResponse = await ElectronicsSupplierService.getById(params.id)
        return {supplier: categoryResponse.data}
    } catch (e) {
        console.log(e)
        return null
    }
...
const AllElectronicsBySupplier = () => {
    ...
    const fetchData = async () => {
        try {
            setLoading(true)
            const response = await ElectronicsSupplierService.getAllBySupplier(supplier?.id)
        ...
        <>
            ...
            <div className='d-flex justify-content-between align-items-center'>
                ...
                <Button
                    type="primary"
                    icon={<PlusOutlined />}
                    onClick={() => editGadget({supplier: supplier?.id})}
                >
                    Add new gadget
                </Button>
...
export default AllElectronicsBySupplier;