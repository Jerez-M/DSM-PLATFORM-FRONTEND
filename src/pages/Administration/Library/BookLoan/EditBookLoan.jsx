import {Button, Card, DatePicker, Divider, Form, message, Select, Tag} from "antd";
...
export async function editBookLoanLoader({request}) {
    try {
...
const EditBookLoan = () => {
    ...
    const borrowersOptions = borrowers?.map((user) => ({
        label: `${user.firstName} ${user.lastName} (${user.reg_number})`,
        value: user.id,
    }));

    if(searchParams.get('book')) {
        form.setFieldsValue({book: +searchParams.get('book')})
    }
                        ...
                        <Card>
                            ...
                            {borrower ? <>
                                ...
                                <p className="table-row">
                                    ...
                                    <strong>{borrower.reg_number}</strong>
                                </p>
                            </> : <>
