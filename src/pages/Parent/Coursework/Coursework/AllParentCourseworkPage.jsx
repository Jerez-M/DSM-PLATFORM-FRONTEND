...
export async function allParentCourseworkLoader({ params }) {
    try {
        ...
        return { termsReturned: termsResponse?.data, classroom_id: studentClassroomResponse?.data?.classroom?.id, activeTermId: activeCurrentTermId, };
    } catch (e) {
        console.log(e);
        return { termsReturned: [], classroom_id: null, activeTermId: null };
    }
}
const AllParentCourseworkPage = () => {
    const { termsReturned, classroom_id, activeTermId } = useLoaderData();
                ...
                <Space size="small">
                    <Tooltip title="More details">
                        <Button
                            ...
                            icon={<EyeOutlined />}
                            onClick={() => {
                                navigate(`/parent/children-coursework/child/${childId}/view/${record.id}`);
                            }}
                        />
                    </Tooltip>
                </Space>
...
export default AllParentCourseworkPage;
