...
export async function studentNewslettersLoader() {
    try {
        const newslettersResponse = await NewsletterService.getAllByAudience(AuthenticationService.getUserTenantId(), "students");
...
export default StudentsNewsletterList;